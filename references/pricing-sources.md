...
- **Best approach**: Use web search to search `site:cargurus.com {year} {make} {model} {trim} for sale` then use `browser` to visit result pages and extract deal ratings and prices.
...
- **Best approach**: Use web search to search `site:cars.com {year} {make} {model} {trim} for sale` then use `browser` to visit listings.
- **Key data**: Listed price, dealer name, mileage, location

### CarFax
- **Search URL**: `https://www.carfax.com/cars-for-sale`
- **Best approach**: Use web search to search `site:carfax.com {year} {make} {model} for sale`.
...
- **Best approach**: Use web search to search `kbb {year} {make} {model} {trim} price value` to find KBB fair market range, private party value, and trade-in value.
...
- **Best approach**: Use web search to search `edmunds {year} {make} {model} {trim} true market value price` to find TMV pricing.
...
4. Search the web for "{year} {make} {model} wholesale value" or "{year} {make} {model} auction price"
